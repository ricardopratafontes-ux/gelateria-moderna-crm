                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      {(cliente.whatsapp || cliente.telefone) && (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-xs font-medium px-2 py-0.5 rounded-full bg-green-100 text-green-700 hover:bg-green-200 transition-colors"
                ...
                <div className="mt-3 pt-3 border-t flex gap-2">
                  ...
                  {(cliente.whatsapp || cliente.telefone) && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 text-sm font-medium text-green-600 hover:bg-green-50 py-1.5 rounded text-center"
                    >
                      WhatsApp
                    </a>
                  )}
